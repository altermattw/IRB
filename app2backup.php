<span class="btn btn-success fileinput-button">
      ...
      <input id="fileupload" type="file" name="files[]" multiple>
	    ...
	    <div id="files" class="files"></div>	    
				...
				<script src="js/jQueryFileUpload/load-image.all.min.js"></script>
				<!-- The Canvas to Blob plugin is included for image resizing functionality -->
				<script src="js/jQueryFileUpload/canvas-to-blob.min.js"></script>
...
<script>
// dynamically loads the CSS styling for the add file buttons:
$('head').append('<link rel="stylesheet" type="text/css" href="css/jquery.fileupload.css">');
...
$(function () {
    ...
    var url = window.location.hostname === 'blueimp.github.io' ?
                '//jquery-file-upload.appspot.com/' : 'php/uploadFile.php',
        uploadButton = $('<button/>')
    ...
    $('#fileupload').fileupload({
        ...
        dataType: 'json',
        autoUpload: false,
        acceptFileTypes: /(\.|\/)(gif|jpe?g|png|doc|docx|pdf|rtf)$/i,
        maxFileSize: 999000,
